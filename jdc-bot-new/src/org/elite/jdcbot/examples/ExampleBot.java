...
public class ExampleBot extends jDCBot {
	...
	public ExampleBot() throws IOException {
		...
		super("ExampleBot", "10.3.113.91", 9007, 10007, "", "This example bot", "LAN(T1)8", "", "107374182400", 3, 6, false);
		try {
			connect("10.129.141.120",411); //my local hub, change it to whatever yours is/
