...
public class FloodMessageThread extends TimerThread{
    ...
    public void onTimer(){
        try{
            _bot.SendPublicMessage("DCBOT is here!!! Commands available: [1.FindRating] +r <moviename> | [2.SuggestMovie] +s <genre> <imdbRating(lowerBound)> <year(rounded-to-nearest-10)> | [3.] +calc <arithmetic-function>");
        }catch(Exception e){}
    }
